...
public class Locations {
    ...
    //shot locations
    public static final Translation2d blueShootingPositions[] = {new Translation2d(blueNoteF.getX() - Units.inchesToMeters(28), blueNoteG.getY()/*midY(blueNoteF, blueNoteG)*/), //between A and B, offset 2ft in
                                                                 new Translation2d(blueNoteG.getX() - Units.inchesToMeters(28), blueNoteG.getY()/*midY(blueNoteG, blueNoteH)*/), //between B and C, offset 2ft in
    ...
    public static final Translation2d redShootingPositions[] =  {new Translation2d(redNoteF.getX() + Units.inchesToMeters(28), redNoteG.getY()/*midY(redNoteF, redNoteG)*/), //between A and B, offset 2ft in
                                                                 new Translation2d(redNoteG.getX() + Units.inchesToMeters(28), redNoteG.getY()/*midY(redNoteG, redNoteH)*/), //between B and C, offset 2ft in
