...
public class Locations {
    ...
    //notes
    public static final Translation2d blueNoteA = new Translation2d (Units.inchesToMeters(fieldLength/2), fieldWidth - Units.inchesToMeters(29.625));
    public static final Translation2d blueNoteB = new Translation2d (Units.inchesToMeters(fieldLength/2), fieldWidth - Units.inchesToMeters(66 + 29.625));
    public static final Translation2d blueNoteC = new Translation2d (Units.inchesToMeters(fieldLength/2), fieldWidth/2);
    public static final Translation2d blueNoteD = new Translation2d (Units.inchesToMeters(fieldLength/2), fieldWidth/2 + Units.inchesToMeters(66));
    public static final Translation2d blueNoteE = new Translation2d (Units.inchesToMeters(fieldLength/2), fieldWidth/2 + Units.inchesToMeters(66*2));
    ...
    //shot locations
    public static final Translation2d blueShootingPositions[] = {new Translation2d(blueNoteF.getX() - Units.inchesToMeters(24), midY(blueNoteF, blueNoteG)), //between A and B, offset 2ft in
    ...
    public static final Translation2d redShootingPositions[] =  {new Translation2d(redNoteF.getX() + Units.inchesToMeters(24), midY(redNoteF, redNoteG)), //between A and B, offset 2ft in
